...
<span class="style1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; LANGUAGES<br />
&nbsp;</span><asp:ImageButton ID="EnglishFlag" ImageUrl="~/Images/EnglishFlag.JPG" AlternateText="English" runat="server" Height="17" Width="25" OnClick="EnglishFlag_Click" CausesValidation="false" />
&nbsp;
